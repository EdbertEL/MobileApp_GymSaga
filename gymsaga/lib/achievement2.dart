...
class Achievement2Screen extends StatelessWidget {
  const Achievement2Screen({Key? key}) : super(key: key);
        ...
        children: [
          Row(
            children: [
              ...
              Image.asset(
                'assets/widgets/images/silver_trophy.png',
                height: 110,
                width: 110,
              ),
            ],
  ...
  Widget _buildAchievementGrid() {
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        // Sample achievement data for Silver level
        List<Map<String, dynamic>> achievements = [
          {
            'title': 'Step Master',
            'description': 'Walked 35,000 steps in a\nsingle day.',
            'progress': 0,
          },
          {
            'title': 'Calories Crusher',
            'description': 'Burned 700 calories in a\nsingle workout.',
            'progress': 0,
          },
          {
          ...
          {
            'title': 'Consistency\nChampion',
            'description': 'Logged workouts for 30\nconsecutive days.',
            'progress': 0,
          },
          {
            'title': 'Distance Dominator',
            'description': 'Walked/Ran a total of 25\nkilometers.',
            'progress': 0,
          },
          {
            'title': 'Personal Best\nBreaker',
            'description': 'Achieved 5 new personal\nbests.',
            'progress': 0,
          },
        ];
          ...
          return Column(
            children: [
              ...
              SizedBox(
                ...
                child: Center(
                  child: Image.asset(
                    'assets/widgets/images/silver_medal.png',
