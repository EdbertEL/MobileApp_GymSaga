      ...
      child: Column(
        children: [
          _buildAchievementRow(
            'Step Master',
            'Walked 35,000 steps in a single day.',
            0,
          ),
          const SizedBox(height: 12),
          _buildAchievementRow(
            'Calories Crusher',
            'Burned 700 calories in a single workout.',
            0,
          ),
          const SizedBox(height: 12),
          _buildAchievementRow(
            'Workout Warrior',
            'Completed 10 workouts in a week.',
            0,
          ),
          const SizedBox(height: 12),
          _buildAchievementRow(
            'Consistency Champion',
            'Logged workouts for 30 consecutive days.',
            0,
          ),
          const SizedBox(height: 12),
          _buildAchievementRow(
            'Distance Dominator',
            'Walked/Ran a total of 25 kilometers.',
            0,
          ),
          const SizedBox(height: 12),
          _buildAchievementRow(
            'Personal Best Breaker',
            'Achieved 5 new personal bests.',
            0,
          ),
        ],
      ),
