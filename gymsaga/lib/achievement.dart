    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        List<Map<String, dynamic>> achievements = [
          {
            'title': 'Step Master',
            'description': 'Walked 10,000 steps in a\nsingle day.',
            'progress': 0,
          },
          {
            'title': 'Calories Crusher',
            'description': 'Burned 300 calories in a\nsingle workout.',
            'progress': 0,
          },
          {
          ...
          {
            'title': 'Consistency\nChampion',
            'description': 'Logged workouts for 7\nconsecutive days.',
            'progress': 0,
          },
          {
            'title': 'Distance Dominator',
            'description': 'Walked/Ran a total of 10\nkilometers.',
            'progress': 0,
          },
          {
            'title': 'Personal Best\nBreaker',
            'description':
                'Achieved a new personal\nbest in any workout metric.',
            'progress': 0,
          },
          {
            'title': 'Levels Dominator',
            'description': 'Reach Levels 10.',
            'progress': 0,
          },
          {
